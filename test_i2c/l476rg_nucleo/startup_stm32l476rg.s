 ...
 *  kismidir. Bu projede I2C'yi KESME ile kullandigimiz icin tablo, L476'nin
 *  31 (I2C1_EV) ve 32 (I2C1_ER) numarali kesmelerine ulasacak kadar
 *  uzatilmistir. (F407'deki master yoklama ile calistigi icin oradaki
 *  tablo kisa kaldi.)
 *
 ...
 *
 *  Bu projede main.c yalnizca su ikisini tanimliyor:
 *      I2C1_EV_IRQHandler   ve   I2C1_ER_IRQHandler
 *  Digerleri tabloda yalnizca DOGRU SIRAYI korumak icin var.
 *
 ...
 * --------------------------------------------------------------------------*/
    ...
    zayif_irq I2C1_EV_IRQHandler     /* main.c bunu tanimliyor -> ezilir */
    zayif_irq I2C1_ER_IRQHandler     /* main.c bunu tanimliyor -> ezilir */
