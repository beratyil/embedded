 ...
 *
 *  Iki dosya arasindaki tek gercek fark, asagidaki IRQ tablosunun cipe ozgu
 *  kismi olurdu -- ama kesme kullanmadigimiz icin o kismi hic yazmiyoruz.
 *
 ...
 *
 *  Asagidaki 16 girdi Cortex-M4'un cekirdek istisnalaridir ve her Cortex-M4
 *  cipte aynidir. Cipe ozgu IRQ'lar (L476'da WWDG, PVD, ... I2C1_EV vb.)
 *  bundan sonra gelirdi; blink icin kesme kullanmadigimizdan yazilmadi.
 *
 *  ILERISI ICIN NOT: I2C'yi kesmeli kullanacaksaniz, ilgili IRQ'nun tabloda
 *  DOGRU SIRADA yer almasi gerekir -- tablo konuma gore calisir, isme gore
 *  degil. O zaman bu tabloyu L476'nin tam kesme listesiyle genisletecegiz.
 * ==========================================================================*/
